...
const NavLink = ({ label, href, icon }) => {
    return (<Link href={href} className='group hover:bg-slate-300 rounded p-2 my-2'>
        <span className='text-3xl text-gray-800'>{icon}</span>
        <section className='absolute z-10 translate-x-12 -translate-y-8 hidden group-hover:flex items-center'>
